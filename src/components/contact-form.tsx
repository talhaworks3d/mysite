...
export function ContactForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="border border-border bg-card p-6 md:p-8 space-y-6">
      {state.errors && (
        <div className="p-3 border border-red-500/50 bg-red-500/10 text-red-500 font-mono text-xs flex items-center space-x-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          />
          <ValidationError prefix="Name" field="name" errors={state.errors} className="text-xs text-red-500 font-mono" />
        </div>
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full bg-background border border-border px-4 py-2.5 font-sans text-xs text-foreground focus:outline-none focus:border-accent transition-colors"
          />
          <ValidationError prefix="Email" field="email" errors={state.errors} className="text-xs text-red-500 font-mono" />
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        ></textarea>
        <ValidationError prefix="Message" field="message" errors={state.errors} className="text-xs text-red-500 font-mono" />
      </div>
