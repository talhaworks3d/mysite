  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border bg-background/90 backdrop-blur-md transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        {/* Brand / Logo */}
        <Link href="/" className="group flex items-center space-x-2 font-mono text-sm tracking-wider">
        ...
        {/* Desktop Navigation */}
        <nav className="hidden md:flex items-center space-x-8 font-mono text-xs tracking-widest">
          {NAV_ITEMS.map((item) => {
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            className="md:hidden p-2 border border-border text-foreground hover:bg-card"
